          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild>
              <Link href="/superadmin">
                {/* 琥珀色のまま、暗い背景から輪郭が立つようグレーの外線を付ける */}
                <div className="flex aspect-square size-8 items-center justify-center rounded-lg border border-gray-500 bg-sidebar-primary text-sidebar-primary-foreground overflow-hidden">
