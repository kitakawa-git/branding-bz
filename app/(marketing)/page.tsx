...
const features: { title: string; description: string; gif: string | null; icon: LucideIcon }[] = [
  {
    title: 'ダッシュボード',
    description: '投稿数・行動指針別の割合・KPI進捗を期間フィルター付きで表示。チームのブランド浸透度が、数字で見えるようになります。',
  ...
  {
    title: 'お知らせ',
    description: '社内イベントやブランド戦略の進捗を、タイムライン形式で全員に配信。いいね機能付きで、情報共有と反応が一か所にまとまります。',
    gif: '/marketing/gifs/announcements.gif',
    icon: Bell,
  },
  {
    title: 'スマート名刺',
    description: 'QRコードからプロフィール＋企業ブランドページを表示。ブランドカラーが自動適用され、名刺交換がブランド体験に変わります。',
    gif: null,
    icon: CreditCard,
  },
  {
  ...
  {
    title: 'ブランディングサポート',
    description: 'ブランド構築の専門サポートをオプションで提供。戦略策定からデザイン制作まで、ID INC. のプロが伴走します。',
