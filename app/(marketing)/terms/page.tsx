    ...
    <>
      ...
      <section className="px-6 pt-6 pb-16 md:pb-24">
        <div className="prose prose-invert prose-gray mx-auto max-w-4xl space-y-10 text-sm leading-relaxed text-white/70">
          ...
          <Section title="第4条（同業者の利用制限）">
            <Ol>
              <li>当社と競合関係にある事業者、またはそのために本サービスを利用しようとする者は、本サービスを利用できません。本条にいう「競合関係にある事業者」とは、ブランディング支援・ブランドコンサルティング・CI/VI設計・デザイン制作・広告／マーケティング支援等、当社の事業と同種または類似のサービスを提供する事業者をいいます。</li>
              <li>当社は、利用登録の申込み時および利用開始後を問わず、ユーザーが前項に該当すると合理的に判断した場合、事前の通知なく登録の拒否、アカウントの利用停止または解約を行うことができます。</li>
              <li>ユーザーは、登録情報（企業名・業種・事業内容・連絡先等）を正確に申告するものとし、競合性の判断のために当社が必要な情報の提供を求めた場合は、これに協力するものとします。</li>
            </Ol>
          </Section>

          <Section title="第5条（アカウント管理）">
            <Ol>
