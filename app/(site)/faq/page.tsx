...
const faqCategories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'はい。AIがブランド構築をガイドする無料ツール（ブランドカラー定義・STP分析等）を提供しており、専門知識がなくても、AIと対話しながらブランドアイデンティティの土台を整理できます。また、ID INC. のブランディング専門家によるサポートオプションもご用意しています。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'ブランドスコアとは何ですか？',
        a: 'ブランド浸透度を0〜100で数値化する機能です。Premium プランでは、インナーサーベイの回答から算出した「インナースコア」とその推移、理解度テストとの「知識×共感」ギャップ分析を確認できます。市場調査を含むアウター（社外からの見え方）を掛け合わせた「統合ブランドスコア」は、結果の解釈と打ち手をセットでご提供するため、四半期の伴走レビューが付く Enterprise プランでのご提供です。',
      },
      {
