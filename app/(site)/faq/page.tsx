...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      {
        q: '無料で使えますか？',
        a: 'はい。Freeプランでは、AIブランディングツール（各ツール 月3回・5ターンまで）を無料でご利用いただけます。生成結果の画面上確認も可能です。PDF出力や本体連携をご利用の場合は、Brand Standard以上のプランが必要です。',
      },
      {
        q: 'プランの違いは何ですか？',
        a: 'Free（¥0）はAI構築ツールの体験、Brand Standard（¥19,800/月）はAI構築ツール使い放題＋ブランド構築＋スマート名刺による発信、Brand Premium（¥59,800/月）は構築＋浸透＋発信＋ブランドスコアによる計測まで全機能をご利用いただけます。300名を超える組織や複数ブランドの統合管理、伴走支援が必要な場合は Enterprise（個別見積）でご相談ください。詳しくは料金ページをご確認ください。',
      },
      {
        q: '想定規模より少ない人数でも上位プランを契約できますか？',
        a: 'はい。想定規模はあくまで目安です。たとえば5〜9名の企業でも Brand Standard をご契約いただけます。メンバー上限（Standard 50名／Premium 300名）だけが機能上の制限です。',
      },
      {
        q: '途中でプラン変更できますか？',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'スマート名刺とは何ですか？',
        a: 'QRコードから社員プロフィール＋企業ブランドページを表示するデジタル名刺です。閲覧数やアウタースコアで効果を測定でき、閲覧者からの印象タグ（マイクロフィードバック）も収集できます。Brand Standard以上のプランでご利用いただけます。',
      },
      {
