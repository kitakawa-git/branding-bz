...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'プランの違いは何ですか？',
        a: 'Free（¥0）はAI構築ツールの体験とブランド掲示の編集、Standard（¥19,800/月）はAI構築ツール使用無制限＋Good Action投稿・お知らせ配信＋スマート名刺による発信、Premium（¥59,800/月）はビデオラーニング・ブランド理解度テスト・目標・KPI管理に加え、インナーサーベイ＋AI設問生成とインナースコア＋推移まで、社内浸透とその計測をご利用いただけます。市場調査を含むアウターを掛け合わせた統合ブランドスコアは、結果の解釈と打ち手をセットでご提供するため Enterprise（個別見積）でのご提供です。詳しくは料金ページをご確認ください。',
      },
      {
