...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'ブランドスコアとは何ですか？',
        a: '社員サーベイ（インナースコア）とスマート名刺の行動データ（アウタースコア）を統合し、ブランド浸透度を0〜100で数値化する機能です。ギャップ分析で「どこに手を打つべきか」が見えます。スコアは解釈と打ち手をセットでご提供するため、四半期の伴走レビューが付く Enterprise プランでのご提供です。',
      },
      {
