...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'プランの違いは何ですか？',
        a: 'Free（¥0）はAI構築ツールの体験、Standard（¥19,800/月）はAI構築ツール使い放題＋ブランド構築＋スマート名刺による発信、Premium（¥59,800/月）は構築＋浸透＋発信＋ブランドスコアによる計測まで全機能をご利用いただけます。300名を超える組織や複数ブランドの統合管理、伴走支援が必要な場合は Enterprise（個別見積）でご相談ください。詳しくは料金ページをご確認ください。',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'ブランドスコアとは何ですか？',
        a: '社員サーベイ（インナースコア）とスマート名刺の行動データ（アウタースコア）を統合し、ブランド浸透度を0〜100で数値化する機能です。部署別ヒートマップやギャップ分析で「どこに手を打つべきか」が見えます。Premiumプランでご利用いただけます。',
      },
      {
      ...
      },
      {
        ...
        a: '行動指針別の投稿数、KPI進捗、利用率をリアルタイムで確認できます。Premiumプランでは、ブランドスコアの推移グラフ・部署別ヒートマップ・ギャップ分析も閲覧可能です。',
      },
    ],
  },
  {
