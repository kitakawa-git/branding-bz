...
const STEPS = [
  ...
  { icon: '2', title: '診断質問（前半）', description: 'ブランドがどう見られたいか、顧客との距離感などを問う5問' },
  { icon: '3', title: '診断質問（後半）', description: '自社が大切にする価値観・語り口など5問' },
  { icon: '4', title: 'AI診断', description: 'AIが回答をもとに、ブランドの個性を言葉とスコアで整理' },
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            <p className="mt-3 text-sm text-white/50">
              ...
              <Link
                ...
                onClick={() => sendGAEvent('event', 'tool_login_click', { tool: 'personality', position: 'hero' })}
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="mt-4 text-sm text-white/50">
              ...
              <Link
                href="/portal/auth?from=personality"
                onClick={() => sendGAEvent('event', 'tool_login_click', { tool: 'personality', position: 'footer' })}
                className="font-semibold text-white underline underline-offset-4 hover:text-white/80"
              >
                ログイン
              </Link>
