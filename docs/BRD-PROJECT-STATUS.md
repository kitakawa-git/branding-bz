...
**最終更新:** 2026-07-14
**更新者:** Claude Code（/sync-status。2026-07-14 その5：代表者プロフィール(companies.representative_profile)を新設し管理画面の代表者名下に AutoResizeTextarea を追加＋ポータル「代表者」行の名前直下に表示（180字超はもっと読むトグル・scrollHeight実測の高さアニメ）、ポータル「私たちについて」を接し方の下（らしさグループ最下段）へ移動、ポータル会社名の主/副をname_display_lang トグルに追従。DDL適用済(SQL Editor)＋migration記録。最新コミット `591ac8c`）
