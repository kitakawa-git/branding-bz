...
**最終更新:** 2026-07-13
**更新者:** Claude Code（同日その2：スローガンに説明文追加、沿革を年/月ドロップダウン化＋ドラッグ並べ替え＋出来事複数行/改行反映、ポータル「考え方」の行動指針/事業内容の余白12px、ポータル「見え方」ロゴ基本形を幅フィット/角丸なし/画像間16px、管理画面ビジュアルのロゴ基本形/ロゴガイドライン画像＋セクションをドラッグ並べ替え化・画像アップロード複数選択対応、会社情報の企業名を日本語/英語＋表示トグルに一本化。DB4カラム追加はSQL Editorで適用済。最新コミット `a1ab1fd`）
