...
**最終更新:** 2026-07-12
**更新者:** Claude Code（STP分析ツール Step3/Step4/Step5 のマップ・ターゲット表示を統一。全ツール共通の見出し余白/ボタン中央整列/ターゲットカード意匠を整備。並行セッションのnews/LP/package/globals.cssには触れず、自分のハンクのみコミット）
