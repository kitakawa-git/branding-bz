...
**最終更新:** 2026-07-14
**更新者:** Claude Code（/sync-status。2026-07-14 その4：ポータル「私たちについて」を「私たちの『らしさ』」グループ先頭（考え方の上）へ移動＋ユーザーメニュー内の項目は削除、ポータル『私たちについて』の事業内容カードから左端青バーと通し番号(01/02..)を削除、基本情報の「概要」見出し/説明文を削除・「ウェブサイトURL」→「ウェブサイト」に短縮・各セクション間余白を20→32pxに統一(`mb-5→mb-8`)・設立/代表者を1カラム独立セクションに分割＋ラベルをh2装飾(`text-xs font-bold mb-3`)に統一＋代表者入力幅を日本語表記に合わせる(`sm:grid-cols-2`の1カラム分)。DB追加DDLなし。最新コミット `21fef26`）
