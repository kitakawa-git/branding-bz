...
function SidebarCard() {
  return (
    <Link
      ...
      className="group animate-in fade-in slide-in-from-bottom-2 block rounded-lg bg-gradient-to-br from-violet-600 to-blue-600 p-4 text-white no-underline duration-700 ease-out transition-all hover:shadow-[0_2px_8px_rgba(124,58,237,0.35)]"
    >
...
function GradientBanner() {
  return (
    <div className="relative mt-4 overflow-hidden rounded-xl bg-gradient-to-br from-violet-600 to-blue-600 px-5 py-6 text-center text-white">
      ...
      <p className="relative m-0 mt-2.5 text-[10.5px] opacity-80">
        所要 30分・オンライン・回数制限なし
      </p>
    </div>
  )
